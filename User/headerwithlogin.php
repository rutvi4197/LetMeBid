...
<div class="header">
    <div class="container">
      ...
      <div class="head-t">
        <ul class="card">
          <li><a href="viewprofile.php" ><i class="fa fa-heart" aria-hidden="true"></i>View Your Profile</a></li>
          ...
          <li><a href="index.php"><i class="fa fa-user"  aria-hidden="true"></i>Point:<span style="color:green"><b><?php echo $point; ?></b></span></a></li>

          <li><a href="sellproduct.php" ><i class="fa fa-arrow-right" aria-hidden="true"></i>Sell Your Product</a></li>

          <li><a href="purchase_history.php" ><i class="fa fa-history" aria-hidden="true"></i>Purchase History</a></li>
          <?php
            $res1=$obj->sell_his($user_id);
            $row=mysql_num_rows($res1);
            if($row>0)
            {
              echo'<li><a href="sell_history.php" ><i class="fa fa-history" aria-hidden="true"></i>Sell history</a></li>   ';
            }
          ?>
           <li><a href="payment.php" ><i class="fa fa-cc-visa" aria-hidden="true"></i>Add Point</a></li>
          ...
          <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
            <ul class="nav navbar-nav ">
              ...
              while($row=mysql_fetch_assoc($res))
              {
                ...
                ?>
                <li><a href="logout.php" class="hyper"> <span style="float: right;">Log Out</span></a></li>
            </ul>
          </div>
          </nav>
