...
<html lang="en">
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Disapproved User Details</h1></center>
      ...
      <?php
          ...
          while($row=mysql_fetch_assoc($res))
          {
            ...
            $user_id=$row["user_id"];
              ...
              <a href="user_del.php?user_id='.$user_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
