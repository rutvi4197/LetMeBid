...
<html lang="en">
  <head>
    ...
    <title>View Current Bid Products </title>
...
<table class="table table-striped table-advance table-hover" id="dataTable">
    <thead>
      ...
      <th><i class="icon_document_alt"></i> User Name</th>
      <th><i class="icon_document_alt"></i> Product Photo</th>
      <th><i class="fa fa-picture-o"></i> Price</th>
    ...
    <tbody>
      <?php
            ...
            $product_id=$_REQUEST["product_id"];
                  ...
                  $obj=new database();
                  $res=$obj->viewcurrentbidproducts($product_id);
