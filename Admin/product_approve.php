    ...
    <tbody>
      <?php
          ...
          $sortcontent=substr($row["product_description"],0,40)."...";
              ...
              <a href="productaction.php?product_id='.$product_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-remove" arial-hidden="true"></span></a></td>
              </tr>';
