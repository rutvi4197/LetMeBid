...
<html lang="en">
  <head>
    ...
    <title>Disapproved Product Details </title>
      ...
      <?php
       ...
       if(isset($_POST["delete"]))
       {
        ...
        if (empty($_POST["chk"])) {
         ...
         {
            $res=$obj->productmuldel($user_email_id);
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Disapproved Product Details</h1></center>
    ...
    <tbody>
      <?php
          ...
          $sortcontent=substr($row["product_description"],0,40)."...";
              ...
              <a href="productactiondel.php?product_id='.$product_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
