...
<html lang="en">
      ...
      <?php
       ...
       if(isset($_POST["delete"]))
       {
        ...
        if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="user_approve.php";
                        </script>';
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Needs To Approve Users Details</h1></center>
      ...
      <?php
          ...
          while($row=mysql_fetch_assoc($res))
          {
            ...
            $user_id=$row["user_id"];
              ...
              <td><img src="../userphoto/'.$row["user_photo"].'" class="imgdisplay"/></td>
              <td>'.$row["user_contact_no"].'</td>
              
              <td><a href="userapp.php?user_id='.$user_id.'" class="btn btn-success"><span class="glyphicon glyphicon-ok" arial-hidden="true"></span></a>

              <a href="useraction.php?user_id='.$user_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-remove" arial-hidden="true"></span></a></td>
              </tr>';
