...
<html lang="en">
  ...
  function allLetter(subcat_name)
{
  var letters=/^[A-Za-z]+$/;
  if(subcat_name.value.match(letters))
  {
      return true;
  }
  else
  ...
  <div class="container-fluid">
   ...
   <?php
            ...
            $obj1=new database();
            $res1=$obj1->insertsubcategory($subcat_name,$fk_cat_id);
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                               <input class="form-control " id="catname" name="subcat_name" type="text" placeholder="Enter Name " onblur="return allLetter(subcat_name);" required="" />
                                          </div>
                                      </div>

                                      <div class="form-group ">
                                          <label class="control-label col-lg-2">Category <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="subcatadd">Add Category</button>
